...
I want to build a QR code generator that lets me generate, view, and save QR codes for URLs the user provides **on a web page** so I can use this to generate QR codes to share whenever I need to.
